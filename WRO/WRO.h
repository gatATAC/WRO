...
#include "_WROPORIS.h"
	...
	* @values      DecisionAparejoMode_UNKNOWN,DecisionAparejoMode_Cerrado
	*/
	enum class enum_DecisionAparejoMode {DecisionAparejoMode_UNKNOWN,DecisionAparejoMode_Cerrado};
