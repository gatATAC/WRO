...
#include "_WROPORIS.h"
	...
	* @values      TramoUNKNOWN,TramoP00,TramoP01,TramoP02,TramoP03,TramoP04,TramoP05,TramoP06,TramoP07,TramoP08
	*/
	enum class enum_TramoMode {TramoUNKNOWN,TramoP00,TramoP01,TramoP02,TramoP03,TramoP04,TramoP05,TramoP06,TramoP07,TramoP08}
	...
	* @description Enum [Mode]
	* @maximum     DecisionAparejoMedio
	* @minimum     DecisionAparejoUNKNOWN
	* @values      DecisionAparejoUNKNOWN,DecisionAparejoCerrado,DecisionAparejoAbierto,DecisionAparejoMedio
	*/
	enum class enum_DecisionAparejoMode {DecisionAparejoUNKNOWN,DecisionAparejoCerrado,DecisionAparejoAbierto,DecisionAparejoMedio}
